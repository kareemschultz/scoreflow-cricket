  ...
  return (
    <div className="min-h-full bg-background relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden>
        <motion.div
          className="absolute -top-16 -right-16 w-64 h-64 rounded-full bg-amber-500/5"
                    ...
                    <CardContent className="py-3 px-4">
                      ...
                      <div className="flex items-center justify-between mt-1.5">
                        <span className="text-[10px] text-muted-foreground">
                          {format(new Date(m.date), "d MMM yyyy")} \u00b7 {m.hands.length} hands
                        </span>
                        <span className={cn("text-[10px] font-semibold text-emerald-500")}>
...
export const Route = createFileRoute("/dominoes/matches/")({
  component: DominoMatchesPage,
})
